...
class PharmacyApp:
    ...
    def create_gui(self):
        ...
        self.show_all_button = tk.Button(self.root, font=20, text="Show All Data", background="cadetblue", foreground="white", command=self.show_all_data)
        self.show_all_button.place(x=630, y=350)
    ...
    def open_sell_window(self):
        ...
        self.medicine_listbox = tk.Listbox(sell_window, selectmode=tk.MULTIPLE)
        ...
        def show_receipt(selected_indices, total_price):
            ...
            receipt_label = tk.Label(receipt_window, text=receipt_text)
            receipt_label.pack()
